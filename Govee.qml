                        ...
                        ColumnLayout{
                            ...
                            Item{
                                ...
                                SButton {
                                    ...
                                    color: (root.device.ignored === true) ? hovered ? Qt.darker("#5664b1", 1.5) : "#5664b1" : hovered ? Qt.darker("#394e61", 1.5) : "#394e61"

                                    label.font.pixelSize: 16
                                    label.text: (root.device.ignored === true) ? "Restore" : "Ignore"
                                    label.font.family: "Red Hat Display"
                                    label.font.bold: true
                                    ...
                                    onClicked: {
                                        if(root.device.ignored === true){
                                            discovery.restore(root.device);
                                        }else {
                                            discovery.ignore(root.device);
                                        }
                                    }
                                }
                            }
